// Mostra a opção de Incremento na hora que selecionamos a Cifra de Cesar

var divChave = document.querySelector(".divChave"); /*O .querySelector está sendo ulizao pra puxar a class divChave pro JS */
var selecaoCod = document.addEventListener("click", /*O addEventListener está aqui pra adicionar um segundo elemento no evento click*/
 function () {
  var codigo = document.getElementById("codigo").value; /*a funçao getElementById serve para retornar um elemento do DOM que é identificado por um ID específico nesse caso a ID=codigo*/
  if (codigo == "cesar") {
...
// Codificador e Decoficador Base64
...
function codificarCesar(msg, chave) {
  return msg
    ...
    .join("");// A função join junta todos os elementos da Array
}
...
// Botao de mudança do texto de Codificar e Decodificar
